...
Для того, чтобы можно было пользоваться программами необходимо чтобы была установлена на ваш компьютер база данных MySQL. 

Должна быть выполнена процедура разметки базы данных.
